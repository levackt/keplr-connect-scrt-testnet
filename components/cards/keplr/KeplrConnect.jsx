    ...
    <Container className="keplr">
      {!keplrEnabled && (
        <div className="enableKeplr">
          <Row justify="center">
          <Typography className={styles.header}>Connect Keplr to pulsar-2</Typography>
          </Row>
          <Row>
      ...
      {keplrEnabled && (
        <div className="keplrCard">
          <Typography className={styles.header}>Keplr connected</Typography>
          <div>
            <p>
